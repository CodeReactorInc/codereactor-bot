...
module.exports = async (fatedata) => {
  ...
  logger.info("Setting 'careful' in "+915+"x"+450);
  ctx.fillText("+"+fatedata.careful, 915, 450);
  logger.info("Setting 'smart' in "+915+"x"+488);
  ctx.fillText("+"+fatedata.smart, 915, 488);
  logger.info("Setting 'stylish' in "+915+"x"+526);
  ctx.fillText("+"+fatedata.stylish, 915, 526);
  logger.info("Setting 'power' in "+915+"x"+564);
  ctx.fillText("+"+fatedata.power, 915, 564);
  logger.info("Setting 'sneaky' in "+915+"x"+602);
  ctx.fillText("+"+fatedata.sneaky, 915, 602);
