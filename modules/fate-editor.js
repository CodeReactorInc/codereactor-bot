...
async function collectApproach(channel, author, fatedata) {
  return new Promise(async (resolve) => {
    allocate(channel, author, {
      agile: fatedata.agile,
      careful: fatedata.careful,
      smart: fatedata.smart,
      stylish: fatedata.stylish,
      power: fatedata.power,
      sneaky: fatedata.sneaky,
      free: []
    }, resolve);
  });
}
...
module.exports = {
  ...
  collectStress: collectStress,
  collectApproach: collectApproach,
